...
void covert_pick_down()
{
  ...
  Serial3.write("G0 X165 Y69 Z60 F100\n"); delay(1500);
  ...
  switch (mode) {
    case RED_MODE :
      ...
      Serial3.write("G0 X160 Y180 Z30 F100\n"); delay(1000);
    ...
    case GREEN_MODE:
      ...
      delay(1000);
      Serial3.write("G0 X160 Y230 Z120 F100\n"); delay(1000);
      Serial3.write("G0 X160 Y230 Z30 F100\n"); delay(1000);
    ...
    case YELLOW_MODE:
      ...
      Serial3.write("G0 X160 Y280 Z30 F100\n"); delay(1000);
      Serial3.write("M2231 V0\n");
